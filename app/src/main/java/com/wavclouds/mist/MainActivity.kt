...
import com.wavclouds.mist.auth.AuthResult
import com.wavclouds.mist.auth.User
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (authToken != null && authToken != "") {
            ...
            btn_submit.setOnClickListener {
                ...
                Log.d("OAUTH", OAUTH_TOKEN_URL)
                Fuel.post(OAUTH_TOKEN_URL, listOf("login" to login, "password" to password)).responseObject(
                    AuthResult.Deserializer()) { req, res, result ->
                    //result is of type Result<User, Exception>
                    val (body, err) = result
